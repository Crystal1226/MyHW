...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice" +
                ", UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM dbo.Products\r\nwher" +
                "e ProductName like \'%\'+@ProductName+\'%\'";
            ...
            this._commandCollection[2].CommandText = "SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice" +
                ", UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM dbo.Products\r\nwher" +
                "e UnitPrice between @UnitPriceBottom and @UnitPriceTop";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@UnitPriceBottom", global::System.Data.SqlDbType.Money, 8, global::System.Data.ParameterDirection.Input, 0, 0, "UnitPrice", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@UnitPriceTop", global::System.Data.SqlDbType.Money, 8, global::System.Data.ParameterDirection.Input, 0, 0, "UnitPrice", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillByProductName(NWDataSet.ProductsDataTable dataTable, string ProductName) {
        ...
        public virtual NWDataSet.ProductsDataTable GetDataBy1(string ProductName) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((ProductName == null)) {
                throw new global::System.ArgumentNullException("ProductName");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByUnitPrice(NWDataSet.ProductsDataTable dataTable, global::System.Nullable<decimal> UnitPriceBottom, global::System.Nullable<decimal> UnitPriceTop) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((UnitPriceBottom.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(UnitPriceBottom.Value));
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            if ((UnitPriceTop.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[1].Value = ((decimal)(UnitPriceTop.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual NWDataSet.ProductsDataTable GetDataBy(global::System.Nullable<decimal> UnitPriceBottom, global::System.Nullable<decimal> UnitPriceTop) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((UnitPriceBottom.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(UnitPriceBottom.Value));
            }
...
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "select*from Customers where City=@City";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(NWDataSet.CustomersDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual NWDataSet.CustomersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByCity(NWDataSet.CustomersDataTable dataTable, string City) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((City == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual NWDataSet.CustomersDataTable GetDataByCity(string City) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((City == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(NWDataSet.CustomersDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
